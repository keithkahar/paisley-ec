              ...
              <div className="mt-[18px]">
                {cards[i + 1] ? (
                  ...
                  >
                    ...
                    <span
                      className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1 h-8 pl-3 pr-2.5 rounded-full cursor-pointer font-normal"
                      onClick={() => scrollToCard(i + 1)}
                      style={{ background: "white", color: "var(--paisley)" }}
                    >
                      升级
                      <ArrowUpRight className="h-[16px] w-[16px]" strokeWidth={2} style={{ color: "var(--paisley)" }} />
                    </span>
                  </button>
                ) : (
                  <button
