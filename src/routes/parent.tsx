...
function GoalRow({
  ...
  return (
    <div
      className="relative flex items-center justify-between px-3 rounded-2xl box-border overflow-hidden"
      style={{ background: "var(--input)", border: `1px solid ${tint(14)}`, height: 64, minHeight: 64, maxHeight: 64 }}
    >
      <span
        className="text-[11px] font-semibold leading-none"
        style={{ color: "color-mix(in oklab, var(--foreground) 65%, white)" }}
