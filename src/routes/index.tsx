    ...
    <PhoneFrame bg="bg-card">
      <div className="relative h-[calc(100dvh-6rem)] overflow-hidden flex flex-col bg-[color:var(--paisley-soft)]">
        ...
        >
          ...
          <Link
            to="/shirin-talk"
            className="relative isolate mt-2 flex items-center justify-center gap-[8px] rounded-full py-4 font-semibold text-white active:scale-[0.98] transition-transform"
            style={{
