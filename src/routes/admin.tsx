    ...
    <div className="mt-4">
      ...
      {srActiveUnit && (
        <>
          ...
          <div className="flex items-baseline justify-between mt-6 mb-2.5">
            <h3 className="text-[15px] font-medium leading-tight" style={{ color: NAVY_C }}>AI Context Preview</h3>
  ...
  return (
    <PhoneFrame bg="bg-white">
      <div className="relative bg-white min-h-full pb-12" style={{ color: NAVY }}>
        ...
        >
          <div className="flex flex-col h-full min-h-0">
            <div className="text-[12px] font-normal text-center leading-[1.55]" style={{ color: MUTED }}>粘贴标准 books 数组或 {`{ books: [...] }`} 对象</div>
          <div className="mt-5 flex-1 min-h-0 overflow-y-auto">
            <textarea
              value={srImportText}
              ...
              <div className="space-y-3 flex-1 min-h-0 overflow-y-auto">
                  ...
                  <SRField label="更新日期">
                    <SRDatePicker
                      ...
                      onChange={(v) => setSrBookEditForm({ ...srBookEditForm, updatedAt: v })}
                      accent={YELLOW}
                    />
                  </SRField>
                  <SRField label="授权">
