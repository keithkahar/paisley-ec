...
const GROUPS: { group: string; rows: Row[] }[] = [
  ...
  },
  {
    group: "会员转化 · 新增",
    rows: [
      { title: "解锁 AI 智能陪伴（ShirinTalk 粉）", slug: "ai-companion", to: "/shirin-talk", search: { sheet: "ai-companion" }, file: "src/components/app/AiUpsellFlow.tsx" },
      { title: "AI学习时间已用完（ShirinTalk 粉）", slug: "ai-quota", to: "/shirin-talk", search: { sheet: "ai-quota" }, file: "src/components/app/AiUpsellFlow.tsx" },
      { title: "解锁更多学习内容（myWordie 蓝）", slug: "content-more", to: "/mywordie", search: { sheet: "content-more" }, file: "src/components/app/ContentUpsellFlow.tsx" },
      { title: "解锁更多学习内容（My Profile 蓝）", slug: "content-more", to: "/profile", search: { sheet: "content-more" }, file: "src/components/app/ContentUpsellFlow.tsx" },
      { title: "解锁更多成长世界（Bloxia 绿）", slug: "world-more", to: "/bloxia", search: { sheet: "world-more" }, file: "src/components/app/WorldUpsellFlow.tsx" },
      { title: "确认订阅 Premium（Parent 蓝）", slug: "confirm-subscribe", to: "/", search: { sheet: "confirm-subscribe" }, file: "src/routes/parent.tsx (ConfirmSubscribeSheet)" },
      { title: "确认订阅 Premium Plus（Parent 蓝）", slug: "confirm-subscribe-plus", to: "/", search: { sheet: "confirm-subscribe-plus" }, file: "src/routes/parent.tsx (ConfirmSubscribeSheet)" },
      { title: "会员已开启（全局）", slug: "membership-activated", to: "/", search: { sheet: "membership-activated" }, file: "src/routes/parent.tsx (MembershipActivatedSheet)" },
      { title: "支付未完成（全局）", slug: "payment-failed", to: "/", search: { sheet: "payment-failed" }, file: "src/routes/parent.tsx (PaymentFailedSheet)" },
      { title: "升级 Premium Plus（Parent 蓝）", slug: "upgrade-plus", to: "/", search: { sheet: "upgrade-plus" }, file: "src/routes/parent.tsx (PlusUpgradeSheet)" },
    ],
  },
];
