...
export const PLACES: Place[] = [
  ...
  { id: "wonder_tree", name: "Wonder Tree", shortName: "Tree", unlockBp: 1000, order: 2, mapPosition: { x: 50, y: 44 }, placeBadgeId: "wonder_tree_explorer", description: "A bright tree for curious questions and new ideas." },
